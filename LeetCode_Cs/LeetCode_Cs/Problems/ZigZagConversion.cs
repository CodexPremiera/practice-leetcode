...
public class ZigZagConversion
{
     ...
     * then concatenates the rows and returns the result. </p>
     *
     * <p> The zigzag pattern is formed by writing the characters of the string in rows
     * and then reading them line by line. </p>
     *
     * <pre>
     * Example:
